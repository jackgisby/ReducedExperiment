...
setMethod(FactorSet, signature = c(assayData = "matrix", reducedData = "matrix",
                                   L = "matrix"),
          function(assayData, reducedData, L,
                   ...
                   ...)
          {
            ...
            .FactorSet(assayData=assayData, reducedData=reducedData, L=L,
